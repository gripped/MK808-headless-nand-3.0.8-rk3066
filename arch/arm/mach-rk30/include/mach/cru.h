...
enum cru_clk_gate {
	/* SCU CLK GATE 0 CON */
	CLK_GATE_CORE_PERIPH = CLK_GATE_CLKID(0), //0
	...
	CLK_GATE_TIMER0 = CLK_GATE_CLKID(1),//16
	CLK_GATE_TIMER1,
	CLK_GATE_TIMER2,
	CLK_GATE_JTAG,
	CLK_GATE_ACLK_LCDC1_SRC, //20
	CLK_GATE_OTGPHY0,
	CLK_GATE_OTGPHY1,
	CLK_GATE_DDR_GPLL,
	CLK_GATE_UART0,
	...
	CLK_GATE_PEIRPH_SRC = CLK_GATE_CLKID(2),//32
	...
	CLK_GATE_ACLK_LCDC0_SRC = CLK_GATE_CLKID(3),//48
	CLK_GATE_DCLK_LCDC0,
	CLK_GATE_DCLK_LCDC1, //50
	...
	CLK_GATE_HCLK_VEPU,
	CLK_GATE_ACLK_VDPU,
	CLK_GATE_HCLK_VDPU, //60
	CLK_GATE_GPU_SRC,
	CLK_GATE3_RES14,
	CLK_GATE_XIN27M,

	CLK_GATE_HCLK_PERI_AXI_MATRIX = CLK_GATE_CLKID(4), //64
	...
	CLK_GATE_HCLK_PERI_AHB_ARBI, //70
	...
	CLK_GATE_ACLK_DMAC1 = CLK_GATE_CLKID(5),//80
	CLK_GATE_ACLK_DMAC2,
	CLK_GATE_PCLK_EFUSE,
	CLK_GATE_PCLK_TZPC,
	CLK_GATE_PCLK_GRF,
	...
	CLK_GATE_ACLK_LCDC0 = CLK_GATE_CLKID(6), //96
	CLK_GATE_HCLK_LCDC0,
	CLK_GATE_HCLK_LCDC1,
	CLK_GATE_ACLK_LCDC1,
	CLK_GATE_HCLK_CIF0, //100
	CLK_GATE_ACLK_CIF0,
	CLK_GATE_HCLK_CIF1,
	CLK_GATE_ACLK_CIF1,
	CLK_GATE_ACLK_IPP,
	...
	CLK_GATE_ACLK_VIO0,
	CLK_GATE_ACLK_VCODEC, //110
	CLK_GATE_SHCLK_VIO_H2H,

	CLK_GATE_HCLK_EMAC = CLK_GATE_CLKID(7), //112
	CLK_GATE_HCLK_SPDIF,
	...
	CLK_GATE_PCLK_UART0 = CLK_GATE_CLKID(8), //128
	CLK_GATE_PCLK_UART1,
	CLK_GATE_PCLK_UART2, //130
	CLK_GATE_PCLK_UART3,
	CLK_GATE_PCLK_I2C0,
	CLK_GATE_PCLK_I2C1,
	CLK_GATE_PCLK_I2C2,
	...
	CLK_GATE_PCLK_GPIO1,
	CLK_GATE_PCLK_GPIO2,
	CLK_GATE_PCLK_GPIO3, //140
	CLK_GATE_PCLK_GPIO4,
	CLK_GATE8_RES14,
	CLK_GATE_PCLK_GPIO6,

	CLK_GATE_CLK_CORE_DBG = CLK_GATE_CLKID(9), //144
	CLK_GATE_PCLK_DBG,
	CLK_GATE_CLK_TRACE,
	CLK_GATE_ATCLK,
	CLK_GATE_CLK_L2C,
	CLK_GATE_ACLK_VIO1,
	CLK_GATE_PCLK_PUBL, //150
